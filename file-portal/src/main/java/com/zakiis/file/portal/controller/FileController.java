...
public class FileController {
	...
	@Permission(roles = {RolesConstants.FILE_WRITE})
	...
	@Permission(roles = {RolesConstants.FILE_READ})
	@GetMapping("/{bucket}/{fileKey}")
	public Mono<Void> downloadFile(@PathVariable String bucket, @PathVariable String fileKey, ServerWebExchange exchange) {
		String ak = CommonUtil.getAk(exchange.getRequest());
